<script>
    ...
    const conversions = [
        ...
        {id: 8, name: "Bicycling, easy (8.7mi/h or 14km/h)", miles: 1.4, km: 2.25},
        {id: 9, name: "Bicycling, moderate (15mi/h - 24km/h)", miles: 2.5, km: 4.02},
        {id: 10, name: "Bicycling, vigorous (20mi/h - 32km/h)", miles: 3.3, km: 5.31},
        ...
        {id: 51, name: "Running, 12min/mi = 7min/km", miles: 0.89, km: 1.43},
        {id: 52, name: "Running, 10min/mi = 5.35min/km", miles: 1.11, km: 1.79},
        {id: 53, name: "Running, 8min/mi = 4.28min/km", miles: 1.39, km: 2.24},
